...
select concat(first_name,' ', last_name) as full_name,title from employee
...
select a.name, count(ab.album_id) as number_of_songs from artist a 
...
/* Q1: Find how much amount spent by each customer on top selling artists? Write a query to return customer name, artist name and total spent */
